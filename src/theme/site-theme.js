export const theme = {
  colors: {
    primary: 'hsl(129,28%,29%)',
    secondary:'hsl(26,49%,83%)',
    tertiary:'hsl(130,35%,62%)',
    success:'#4BB543',
    alert:'#bb2124',
    warning:'#f0ad4e',
    link: '#5bc0de',
  ...
  fonts:{
    headline:'libre-franklin, sans-serif',
    body: ''
  },
  font_size:{
  /* Display */
  ...
  /* Body */
  body_large: '1.125rem',  // 18px - Desktop
  ...
  layout:{
    desktop:'minmax(2em,1fr) repeat(12,minmax(auto,12em)) minmax(2em,1fr)',
    tablet:'minmax(2em,1fr) repeat(8,minmax(auto,1fr)) minmax(2em,1fr)',
    mobile:'minmax(1em,1fr) repeat(4,minmax(auto,1fr)) minmax(1em,1fr)',
